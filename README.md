...
### Design Achievements
- **Color Palette: Created a color pallete using warm colors on Adobe and implemented the colors into all of the font colors that blended well together.**
- **Font: Chose the Roboto font from google fonts, imported it and changed the font family for the body to be Roboto.**
  Assignment 1 - Hello World: Basic Deployment w/ Git, GitHub, Glitch
  ===
...
Nick Rogerson
http://a1-nrogerson234.glitch.me
