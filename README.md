...
- Used CSS. Created a .css file, in order to edit the background color by making it a gradient, formatting a table, adding dividers, adding images, changing color of text, and aligning everything to the center of the page.
