...
- **Added 5+ style rules for the CSS Styling of the page**: I implemented 5+ different style rules ranging from font-family, background-color, borders, text-align, font-size, height/width of an image and animation, letter spacing, and padding. I had colors (using my color palette) for the background of the page and also for the text. Not only that, I encapsulated the information in a solid border that is also on my image. I have also set most of the text to be of a certain size and following a certain font family (New Amsterdam). On the other hand, I have formatted the table to have borders and also its own background color whilst aligning the text to centered. Not only that, I added some padding and letter-spacing to format the data in the table to be more uniform. I also formatted the unordered list to be upper-roman.
- **Javascript Animation**: I have implemented a simple Javascript function (script.js) that changes the color of the H1 tag in script.js. It goes through an array of colors from my color palette. I have also implemented keyframes in the css file that also animates the colors for the H2 tag.
